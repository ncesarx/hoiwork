...
export function PremiumHome() {
  return <div className="site">
    <header className="navbar"><div className="container navbar__inner">
      <a href="#inicio" className="brand" aria-label="Home & Office Tech Solutions"><Image src="/brand/logo-premium.svg" alt="Home & Office Tech Solutions" width={520} height={118} priority /></a>
